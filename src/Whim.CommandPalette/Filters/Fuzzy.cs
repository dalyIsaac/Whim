...
public static partial class PaletteFilters
{
	...
	/// </summary>
	public static readonly PaletteFilter MatchesFuzzyContiguous = Or(
		MatchesRegex,
		MatchesPrefix,
		MatchesCamelCase,
	...
	/// </summary>
	public static readonly PaletteFilter MatchesFuzzySeparate = Or(
		MatchesRegex,
		MatchesPrefix,
		MatchesCamelCase,
		MatchesSubString
	...
	/// </summary>
	public static readonly PaletteFilter MatchesWords = Or(
		MatchesPrefix,
		MatchesWordsSeparate,
		MatchesContiguousSubString
	);
}
