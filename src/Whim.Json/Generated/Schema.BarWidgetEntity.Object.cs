...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct BarWidgetEntity : IJsonObject<BarWidgetEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "BarWidgetEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public BarWidgetEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator BarWidgetEntity(JsonObject value)
        {
        ...
        public static BarWidgetEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static BarWidgetEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static BarWidgetEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public BarWidgetEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public BarWidgetEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public BarWidgetEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public BarWidgetEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public BarWidgetEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
