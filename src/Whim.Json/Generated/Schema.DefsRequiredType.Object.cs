...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct DefsRequiredType : IJsonObject<DefsRequiredType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DefsRequiredType"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DefsRequiredType(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator DefsRequiredType(JsonObject value)
        {
        ...
        public static DefsRequiredType FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefsRequiredType FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefsRequiredType FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DefsRequiredType SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public DefsRequiredType RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
