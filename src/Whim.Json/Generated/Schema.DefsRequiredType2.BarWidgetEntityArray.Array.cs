...
[CollectionBuilder(typeof(BarWidgetEntityArray), "Create")]
public readonly partial struct BarWidgetEntityArray : IJsonArray<BarWidgetEntityArray>, IReadOnlyCollection<Whim.Json.Schema.BarWidgetEntity>
#else
        public readonly partial struct BarWidgetEntityArray : IJsonArray<BarWidgetEntityArray>, IReadOnlyCollection<Whim.Json.Schema.BarWidgetEntity>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly BarWidgetEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "BarWidgetEntityArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public BarWidgetEntityArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public BarWidgetEntityArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<BarWidgetEntityArray>.this[int index]
            {
                get
                {
            ...
            public Whim.Json.Schema.BarWidgetEntity this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Whim.Json.Schema.BarWidgetEntity(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<Whim.Json.Schema.BarWidgetEntity>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(BarWidgetEntityArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator BarWidgetEntityArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator BarWidgetEntityArray(JsonArray value)
            {
            ...
            public static BarWidgetEntityArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            public static BarWidgetEntityArray Create(ReadOnlySpan<Whim.Json.Schema.BarWidgetEntity> items)
            {
                return new([..items]);
            }
            ...
            /// <returns>A BarWidgetEntityArray instantiated from the given items.</returns>
            public static BarWidgetEntityArray FromItems(in Whim.Json.Schema.BarWidgetEntity value1)
            {
            ...
            /// <returns>A BarWidgetEntityArray instantiated from the given items.</returns>
            public static BarWidgetEntityArray FromItems(in Whim.Json.Schema.BarWidgetEntity value1, in Whim.Json.Schema.BarWidgetEntity value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A BarWidgetEntityArray instantiated from the given items.</returns>
            public static BarWidgetEntityArray FromItems(in Whim.Json.Schema.BarWidgetEntity value1, in Whim.Json.Schema.BarWidgetEntity value2, in Whim.Json.Schema.BarWidgetEntity value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static BarWidgetEntityArray FromItems(params Whim.Json.Schema.BarWidgetEntity[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Whim.Json.Schema.BarWidgetEntity item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static BarWidgetEntityArray FromRange(IEnumerable<Whim.Json.Schema.BarWidgetEntity> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Whim.Json.Schema.BarWidgetEntity item in value)
                {
            ...
            /// </remarks>
            public static BarWidgetEntityArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new BarWidgetEntityArray(builder.ToImmutable());
            }
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static BarWidgetEntityArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static BarWidgetEntityArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            IEnumerator<Whim.Json.Schema.BarWidgetEntity> IEnumerable<Whim.Json.Schema.BarWidgetEntity>.GetEnumerator()
            {
            ...
            /// <inheritdoc/>
            int IReadOnlyCollection<Whim.Json.Schema.BarWidgetEntity>.Count => this.GetArrayLength();
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<Whim.Json.Schema.BarWidgetEntity> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Whim.Json.Schema.BarWidgetEntity>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Whim.Json.Schema.BarWidgetEntity>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<BarWidgetEntityArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<BarWidgetEntityArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
