...
public readonly partial struct Schema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct DefsRequiredType3 : IJsonObject<DefsRequiredType3>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DefsRequiredType3"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DefsRequiredType3(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator DefsRequiredType3(JsonObject value)
        {
        ...
        public static DefsRequiredType3 FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefsRequiredType3 FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefsRequiredType3 FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DefsRequiredType3 SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public DefsRequiredType3 RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType3 RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType3 RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType3 RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
