...
public readonly partial struct Schema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct DefsRequiredType4 : IJsonObject<DefsRequiredType4>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DefsRequiredType4"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DefsRequiredType4(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator DefsRequiredType4(JsonObject value)
        {
        ...
        public static DefsRequiredType4 FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefsRequiredType4 FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefsRequiredType4 FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DefsRequiredType4 SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public DefsRequiredType4 RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType4 RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType4 RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DefsRequiredType4 RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
