...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct LayoutEngineEntity : IJsonObject<LayoutEngineEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "LayoutEngineEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public LayoutEngineEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator LayoutEngineEntity(JsonObject value)
        {
        ...
        public static LayoutEngineEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static LayoutEngineEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static LayoutEngineEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public LayoutEngineEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public LayoutEngineEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public LayoutEngineEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public LayoutEngineEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public LayoutEngineEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
