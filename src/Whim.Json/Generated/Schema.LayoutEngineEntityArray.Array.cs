...
[CollectionBuilder(typeof(LayoutEngineEntityArray), "Create")]
public readonly partial struct LayoutEngineEntityArray : IJsonArray<LayoutEngineEntityArray>, IReadOnlyCollection<Whim.Json.Schema.LayoutEngineEntity>
#else
    public readonly partial struct LayoutEngineEntityArray : IJsonArray<LayoutEngineEntityArray>, IReadOnlyCollection<Whim.Json.Schema.LayoutEngineEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly LayoutEngineEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "LayoutEngineEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public LayoutEngineEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public LayoutEngineEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<LayoutEngineEntityArray>.this[int index]
        {
            get
            {
        ...
        public Whim.Json.Schema.LayoutEngineEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Whim.Json.Schema.LayoutEngineEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Whim.Json.Schema.LayoutEngineEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(LayoutEngineEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator LayoutEngineEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator LayoutEngineEntityArray(JsonArray value)
        {
        ...
        public static LayoutEngineEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static LayoutEngineEntityArray Create(ReadOnlySpan<Whim.Json.Schema.LayoutEngineEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A LayoutEngineEntityArray instantiated from the given items.</returns>
        public static LayoutEngineEntityArray FromItems(in Whim.Json.Schema.LayoutEngineEntity value1)
        {
        ...
        /// <returns>A LayoutEngineEntityArray instantiated from the given items.</returns>
        public static LayoutEngineEntityArray FromItems(in Whim.Json.Schema.LayoutEngineEntity value1, in Whim.Json.Schema.LayoutEngineEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A LayoutEngineEntityArray instantiated from the given items.</returns>
        public static LayoutEngineEntityArray FromItems(in Whim.Json.Schema.LayoutEngineEntity value1, in Whim.Json.Schema.LayoutEngineEntity value2, in Whim.Json.Schema.LayoutEngineEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static LayoutEngineEntityArray FromItems(params Whim.Json.Schema.LayoutEngineEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.LayoutEngineEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static LayoutEngineEntityArray FromRange(IEnumerable<Whim.Json.Schema.LayoutEngineEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.LayoutEngineEntity item in value)
            {
        ...
        /// </remarks>
        public static LayoutEngineEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new LayoutEngineEntityArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static LayoutEngineEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static LayoutEngineEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<Whim.Json.Schema.LayoutEngineEntity> IEnumerable<Whim.Json.Schema.LayoutEngineEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Whim.Json.Schema.LayoutEngineEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Whim.Json.Schema.LayoutEngineEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.LayoutEngineEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.LayoutEngineEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<LayoutEngineEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<LayoutEngineEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
