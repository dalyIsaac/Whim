...
[CollectionBuilder(typeof(MonitorEntityArray), "Create")]
public readonly partial struct MonitorEntityArray : IJsonArray<MonitorEntityArray>, IReadOnlyCollection<Whim.Json.Schema.MonitorEntity>
#else
    public readonly partial struct MonitorEntityArray : IJsonArray<MonitorEntityArray>, IReadOnlyCollection<Whim.Json.Schema.MonitorEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly MonitorEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "MonitorEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public MonitorEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public MonitorEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<MonitorEntityArray>.this[int index]
        {
            get
            {
        ...
        public Whim.Json.Schema.MonitorEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Whim.Json.Schema.MonitorEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Whim.Json.Schema.MonitorEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(MonitorEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator MonitorEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator MonitorEntityArray(JsonArray value)
        {
        ...
        public static MonitorEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static MonitorEntityArray Create(ReadOnlySpan<Whim.Json.Schema.MonitorEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A MonitorEntityArray instantiated from the given items.</returns>
        public static MonitorEntityArray FromItems(in Whim.Json.Schema.MonitorEntity value1)
        {
        ...
        /// <returns>A MonitorEntityArray instantiated from the given items.</returns>
        public static MonitorEntityArray FromItems(in Whim.Json.Schema.MonitorEntity value1, in Whim.Json.Schema.MonitorEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A MonitorEntityArray instantiated from the given items.</returns>
        public static MonitorEntityArray FromItems(in Whim.Json.Schema.MonitorEntity value1, in Whim.Json.Schema.MonitorEntity value2, in Whim.Json.Schema.MonitorEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static MonitorEntityArray FromItems(params Whim.Json.Schema.MonitorEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.MonitorEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static MonitorEntityArray FromRange(IEnumerable<Whim.Json.Schema.MonitorEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.MonitorEntity item in value)
            {
        ...
        /// </remarks>
        public static MonitorEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new MonitorEntityArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static MonitorEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static MonitorEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<Whim.Json.Schema.MonitorEntity> IEnumerable<Whim.Json.Schema.MonitorEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Whim.Json.Schema.MonitorEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Whim.Json.Schema.MonitorEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.MonitorEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.MonitorEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<MonitorEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<MonitorEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
