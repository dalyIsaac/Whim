...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginEntity
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Whim.Json.Schema.DefsRequiredType4>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<Whim.Json.Schema.DefsRequiredType3>().Validate(childContext1.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult2 = this.As<Whim.Json.Schema.DefsRequiredType2>().Validate(childContext2.CreateChildContext(), level);
