...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginEntityArray
    {
        ...
        PluginEntityArray IJsonArray<PluginEntityArray>.Remove(in JsonAny item1)
        {
        ...
        public PluginEntityArray Remove(in Whim.Json.Schema.PluginEntity item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PluginEntityArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PluginEntityArray RemoveRange(int index, int count)
        {
