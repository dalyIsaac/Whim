...
[CollectionBuilder(typeof(PluginEntityArray), "Create")]
public readonly partial struct PluginEntityArray : IJsonArray<PluginEntityArray>, IReadOnlyCollection<Whim.Json.Schema.PluginEntity>
#else
    public readonly partial struct PluginEntityArray : IJsonArray<PluginEntityArray>, IReadOnlyCollection<Whim.Json.Schema.PluginEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly PluginEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "PluginEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PluginEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PluginEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<PluginEntityArray>.this[int index]
        {
            get
            {
        ...
        public Whim.Json.Schema.PluginEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Whim.Json.Schema.PluginEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Whim.Json.Schema.PluginEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(PluginEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PluginEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PluginEntityArray(JsonArray value)
        {
        ...
        public static PluginEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static PluginEntityArray Create(ReadOnlySpan<Whim.Json.Schema.PluginEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A PluginEntityArray instantiated from the given items.</returns>
        public static PluginEntityArray FromItems(in Whim.Json.Schema.PluginEntity value1)
        {
        ...
        /// <returns>A PluginEntityArray instantiated from the given items.</returns>
        public static PluginEntityArray FromItems(in Whim.Json.Schema.PluginEntity value1, in Whim.Json.Schema.PluginEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A PluginEntityArray instantiated from the given items.</returns>
        public static PluginEntityArray FromItems(in Whim.Json.Schema.PluginEntity value1, in Whim.Json.Schema.PluginEntity value2, in Whim.Json.Schema.PluginEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static PluginEntityArray FromItems(params Whim.Json.Schema.PluginEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.PluginEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static PluginEntityArray FromRange(IEnumerable<Whim.Json.Schema.PluginEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.PluginEntity item in value)
            {
        ...
        /// </remarks>
        public static PluginEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new PluginEntityArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PluginEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PluginEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<Whim.Json.Schema.PluginEntity> IEnumerable<Whim.Json.Schema.PluginEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Whim.Json.Schema.PluginEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Whim.Json.Schema.PluginEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.PluginEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.PluginEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<PluginEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<PluginEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
