...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct RequiredCommandAndKeybind : IJsonObject<RequiredCommandAndKeybind>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "RequiredCommandAndKeybind"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RequiredCommandAndKeybind(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator RequiredCommandAndKeybind(JsonObject value)
        {
        ...
        public static RequiredCommandAndKeybind FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static RequiredCommandAndKeybind FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static RequiredCommandAndKeybind FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public RequiredCommandAndKeybind SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public RequiredCommandAndKeybind RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public RequiredCommandAndKeybind RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public RequiredCommandAndKeybind RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public RequiredCommandAndKeybind RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
