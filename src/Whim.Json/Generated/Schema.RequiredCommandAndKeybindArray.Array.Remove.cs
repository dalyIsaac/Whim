...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredCommandAndKeybindArray
    {
        ...
        RequiredCommandAndKeybindArray IJsonArray<RequiredCommandAndKeybindArray>.Remove(in JsonAny item1)
        {
        ...
        public RequiredCommandAndKeybindArray Remove(in Whim.Json.Schema.RequiredCommandAndKeybind item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RequiredCommandAndKeybindArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RequiredCommandAndKeybindArray RemoveRange(int index, int count)
        {
