...
[CollectionBuilder(typeof(RequiredCommandAndKeybindArray), "Create")]
public readonly partial struct RequiredCommandAndKeybindArray : IJsonArray<RequiredCommandAndKeybindArray>, IReadOnlyCollection<Whim.Json.Schema.RequiredCommandAndKeybind>
#else
    public readonly partial struct RequiredCommandAndKeybindArray : IJsonArray<RequiredCommandAndKeybindArray>, IReadOnlyCollection<Whim.Json.Schema.RequiredCommandAndKeybind>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly RequiredCommandAndKeybindArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "RequiredCommandAndKeybindArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RequiredCommandAndKeybindArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RequiredCommandAndKeybindArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<RequiredCommandAndKeybindArray>.this[int index]
        {
            get
            {
        ...
        public Whim.Json.Schema.RequiredCommandAndKeybind this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Whim.Json.Schema.RequiredCommandAndKeybind(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Whim.Json.Schema.RequiredCommandAndKeybind>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(RequiredCommandAndKeybindArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RequiredCommandAndKeybindArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RequiredCommandAndKeybindArray(JsonArray value)
        {
        ...
        public static RequiredCommandAndKeybindArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static RequiredCommandAndKeybindArray Create(ReadOnlySpan<Whim.Json.Schema.RequiredCommandAndKeybind> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A RequiredCommandAndKeybindArray instantiated from the given items.</returns>
        public static RequiredCommandAndKeybindArray FromItems(in Whim.Json.Schema.RequiredCommandAndKeybind value1)
        {
        ...
        /// <returns>A RequiredCommandAndKeybindArray instantiated from the given items.</returns>
        public static RequiredCommandAndKeybindArray FromItems(in Whim.Json.Schema.RequiredCommandAndKeybind value1, in Whim.Json.Schema.RequiredCommandAndKeybind value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A RequiredCommandAndKeybindArray instantiated from the given items.</returns>
        public static RequiredCommandAndKeybindArray FromItems(in Whim.Json.Schema.RequiredCommandAndKeybind value1, in Whim.Json.Schema.RequiredCommandAndKeybind value2, in Whim.Json.Schema.RequiredCommandAndKeybind value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static RequiredCommandAndKeybindArray FromItems(params Whim.Json.Schema.RequiredCommandAndKeybind[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.RequiredCommandAndKeybind item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static RequiredCommandAndKeybindArray FromRange(IEnumerable<Whim.Json.Schema.RequiredCommandAndKeybind> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.RequiredCommandAndKeybind item in value)
            {
        ...
        /// </remarks>
        public static RequiredCommandAndKeybindArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new RequiredCommandAndKeybindArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static RequiredCommandAndKeybindArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static RequiredCommandAndKeybindArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<Whim.Json.Schema.RequiredCommandAndKeybind> IEnumerable<Whim.Json.Schema.RequiredCommandAndKeybind>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Whim.Json.Schema.RequiredCommandAndKeybind>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Whim.Json.Schema.RequiredCommandAndKeybind> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.RequiredCommandAndKeybind>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.RequiredCommandAndKeybind>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<RequiredCommandAndKeybindArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<RequiredCommandAndKeybindArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
