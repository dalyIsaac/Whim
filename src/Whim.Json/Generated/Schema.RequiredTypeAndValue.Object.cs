...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct RequiredTypeAndValue : IJsonObject<RequiredTypeAndValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "RequiredTypeAndValue"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RequiredTypeAndValue(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator RequiredTypeAndValue(JsonObject value)
        {
        ...
        public static RequiredTypeAndValue FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static RequiredTypeAndValue FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static RequiredTypeAndValue FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public RequiredTypeAndValue SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public RequiredTypeAndValue RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public RequiredTypeAndValue RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public RequiredTypeAndValue RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public RequiredTypeAndValue RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
