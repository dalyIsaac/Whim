...
[CollectionBuilder(typeof(RequiredTypeAndValueArray), "Create")]
public readonly partial struct RequiredTypeAndValueArray : IJsonArray<RequiredTypeAndValueArray>, IReadOnlyCollection<Whim.Json.Schema.RequiredTypeAndValue>
#else
    public readonly partial struct RequiredTypeAndValueArray : IJsonArray<RequiredTypeAndValueArray>, IReadOnlyCollection<Whim.Json.Schema.RequiredTypeAndValue>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly RequiredTypeAndValueArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "RequiredTypeAndValueArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RequiredTypeAndValueArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RequiredTypeAndValueArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<RequiredTypeAndValueArray>.this[int index]
        {
            get
            {
        ...
        public Whim.Json.Schema.RequiredTypeAndValue this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Whim.Json.Schema.RequiredTypeAndValue(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Whim.Json.Schema.RequiredTypeAndValue>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(RequiredTypeAndValueArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RequiredTypeAndValueArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RequiredTypeAndValueArray(JsonArray value)
        {
        ...
        public static RequiredTypeAndValueArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static RequiredTypeAndValueArray Create(ReadOnlySpan<Whim.Json.Schema.RequiredTypeAndValue> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A RequiredTypeAndValueArray instantiated from the given items.</returns>
        public static RequiredTypeAndValueArray FromItems(in Whim.Json.Schema.RequiredTypeAndValue value1)
        {
        ...
        /// <returns>A RequiredTypeAndValueArray instantiated from the given items.</returns>
        public static RequiredTypeAndValueArray FromItems(in Whim.Json.Schema.RequiredTypeAndValue value1, in Whim.Json.Schema.RequiredTypeAndValue value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A RequiredTypeAndValueArray instantiated from the given items.</returns>
        public static RequiredTypeAndValueArray FromItems(in Whim.Json.Schema.RequiredTypeAndValue value1, in Whim.Json.Schema.RequiredTypeAndValue value2, in Whim.Json.Schema.RequiredTypeAndValue value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static RequiredTypeAndValueArray FromItems(params Whim.Json.Schema.RequiredTypeAndValue[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.RequiredTypeAndValue item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static RequiredTypeAndValueArray FromRange(IEnumerable<Whim.Json.Schema.RequiredTypeAndValue> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.RequiredTypeAndValue item in value)
            {
        ...
        /// </remarks>
        public static RequiredTypeAndValueArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new RequiredTypeAndValueArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static RequiredTypeAndValueArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static RequiredTypeAndValueArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<Whim.Json.Schema.RequiredTypeAndValue> IEnumerable<Whim.Json.Schema.RequiredTypeAndValue>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Whim.Json.Schema.RequiredTypeAndValue>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Whim.Json.Schema.RequiredTypeAndValue> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.RequiredTypeAndValue>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.RequiredTypeAndValue>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<RequiredTypeAndValueArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<RequiredTypeAndValueArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
