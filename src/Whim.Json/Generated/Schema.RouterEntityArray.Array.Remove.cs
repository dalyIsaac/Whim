...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RouterEntityArray
    {
        ...
        RouterEntityArray IJsonArray<RouterEntityArray>.Remove(in JsonAny item1)
        {
        ...
        public RouterEntityArray Remove(in Whim.Json.Schema.RouterEntity item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RouterEntityArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RouterEntityArray RemoveRange(int index, int count)
        {
