...
[CollectionBuilder(typeof(RouterEntityArray), "Create")]
public readonly partial struct RouterEntityArray : IJsonArray<RouterEntityArray>, IReadOnlyCollection<Whim.Json.Schema.RouterEntity>
#else
    public readonly partial struct RouterEntityArray : IJsonArray<RouterEntityArray>, IReadOnlyCollection<Whim.Json.Schema.RouterEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly RouterEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "RouterEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RouterEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RouterEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<RouterEntityArray>.this[int index]
        {
            get
            {
        ...
        public Whim.Json.Schema.RouterEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Whim.Json.Schema.RouterEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Whim.Json.Schema.RouterEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(RouterEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RouterEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RouterEntityArray(JsonArray value)
        {
        ...
        public static RouterEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static RouterEntityArray Create(ReadOnlySpan<Whim.Json.Schema.RouterEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A RouterEntityArray instantiated from the given items.</returns>
        public static RouterEntityArray FromItems(in Whim.Json.Schema.RouterEntity value1)
        {
        ...
        /// <returns>A RouterEntityArray instantiated from the given items.</returns>
        public static RouterEntityArray FromItems(in Whim.Json.Schema.RouterEntity value1, in Whim.Json.Schema.RouterEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A RouterEntityArray instantiated from the given items.</returns>
        public static RouterEntityArray FromItems(in Whim.Json.Schema.RouterEntity value1, in Whim.Json.Schema.RouterEntity value2, in Whim.Json.Schema.RouterEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static RouterEntityArray FromItems(params Whim.Json.Schema.RouterEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.RouterEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static RouterEntityArray FromRange(IEnumerable<Whim.Json.Schema.RouterEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Whim.Json.Schema.RouterEntity item in value)
            {
        ...
        /// </remarks>
        public static RouterEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new RouterEntityArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static RouterEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static RouterEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<Whim.Json.Schema.RouterEntity> IEnumerable<Whim.Json.Schema.RouterEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Whim.Json.Schema.RouterEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Whim.Json.Schema.RouterEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.RouterEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Whim.Json.Schema.RouterEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<RouterEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<RouterEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
