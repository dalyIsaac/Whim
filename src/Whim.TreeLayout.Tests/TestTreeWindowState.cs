...
{
	public static ILocation<double> Left = new DoubleLocation()
	{
		X = 0,
		Y = 0,
		Width = 0.5,
	...
	public static ILocation<double> RightBottom = new DoubleLocation()
	{
		X = 0.5,
		Y = 0.5,
		Width = 0.5,
	...
	public static ILocation<double> RightTopLeftTop = new DoubleLocation()
	{
		X = 0.5,
		Y = 0,
		Width = 0.25,
	...
	public static ILocation<double> RightTopLeftBottomLeft = new DoubleLocation()
	{
		X = 0.5,
		Y = 0.25,
		Width = 0.125,
	...
	public static ILocation<double> RightTopLeftBottomRightTop = new DoubleLocation()
	{
		X = 0.625,
		Y = 0.25,
		Width = 0.125,
	...
	public static ILocation<double> RightTopLeftBottomRightBottom = new DoubleLocation()
	{
		X = 0.625,
		Y = 0.425,
		Width = 0.125,
	...
	public static ILocation<double> RightTopRight1 = new DoubleLocation()
	{
		X = 0.75,
		Y = 0,
		Width = 0.25,
	...
	public static ILocation<double> RightTopRight2 = new DoubleLocation()
	{
		X = 0.75,
		Y = 0.5 * 1d / 3,
		Width = 0.25,
	...
	public static ILocation<double> RightTopRight3 = new DoubleLocation()
	{
		X = 0.75,
		Y = 1d / 3,
		Width = 0.25,
