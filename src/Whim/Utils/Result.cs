...
/// <summary>
/// A custom Result type that matches the interface of DotNext's Result but uses WhimError for error handling.
...
public readonly struct Result<T>
{
	...
	/// <summary>
	/// Creates a new Result instance representing a successful operation with no value.
	/// </summary>
	public Result()
	{
		_value = default;
